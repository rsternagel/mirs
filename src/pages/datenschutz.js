...
const Datenschutz = ({
  ...
  <div>
    ...
    <p>
      ...
      oder komplett verhindert wird. Allerdings wird darauf hingewiesen, dass die
    ...
    <p>
      ...
      {' '}<a href="http://www.aboutads.info/choices/">US-amerikanische Seite</a> oder
      die <a href="http://www.youronlinechoices.com/uk/your-ad-choices/">EU-Seite</a> verwalten.
    </p>

    <h2>Datenanalyse: Clicky Web Analytics</h2>
    <p>
      Diese Website benutzt Clicky, einen Webanalysedienst der Roxr Software,
      Ltd. Clicky verwendet sog. „Cookies“, Textdateien, die auf Ihrem
      Computer gespeichert werden und die eine Analyse der Benutzung der
      Website durch Sie ermöglichen. Die durch diese Cookies erzeugten
      Informationen über Ihre Benutzung dieser Website werden an einen Server
      der Roxr Software, Ltd. in den USA übertragen und dort gespeichert.
    </p>

    <p>
      Ich weise ausdrücklich darauf hin, dass Clicky auf dieser Seite mit der
      Option „Anonymize IP addresses“ verwendet wird, welche das letzte Oktett Ihrer
      IP-Adresse durch eine 0 ersetzt. Ihre IP-Adresse wird somit anonymisiert
      gespeichert und kann nicht von mir eingesehen werden.
    </p>

    <p>
      Clicky wird durch Cookies erzeugte Informationen benutzen, um Ihre
      Nutzung der Website auszuwerten, um Reports über die
      Websiteaktivitäten für die Websitebetreiber zusammenzustellen und
      um weitere mit der Website- und der Internetnutzung verbundene
      Dienstleistungen zu erbringen. Auch wird Clicky diese Informationen
      gegebenenfalls an Dritte übertragen, sofern dies gesetzlich
      vorgeschrieben oder soweit Dritte diese Daten im Auftrag von Clicky
      verarbeiten.
    </p>
    ...
    <p>
      ...
      Browser-Software verhindern. Ich weise Sie jedoch darauf hin, dass Sie
      ...
      Clicky in der zuvor beschriebenen Art und Weise und zu dem zuvor benannten
      Zweck einverstanden.
    </p>

    <p>
      Hier finde Sie eine <a href="http://clicky.com/terms">genaue Erklärung der
      Funktionsweise von Clicky Web Analytics und allen verwendeten Cookies</a>.
    </p>
  </div>
)
